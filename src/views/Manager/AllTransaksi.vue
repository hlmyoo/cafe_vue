      ...
      <section id="menu" class="menu section-bg">
                  <div class="container" data-aos="fade-up">
                      ...
                      <div class="section-title">
                       ...
                       <input type="text" name="" id=""  class="form-control mb-4" v-model="cari_user">
...
export default {
    ...
    computed: {
        filterdata() {
            ...
            if (this.cari_user) {
                filterdata = filterdata.filter(transaksi => transaksi.nama_user.toString().toLowerCase().includes(this.cari_user.toLowerCase()))
            }
            return filterdata
        }
    },
    methods: {
        ...
        gettotal(history) {
            axios.get('http://localhost:8000/api/gethasilharga/' + history.id_pelayanan)
                .then(
                    ({ data }) => {
                        console.log(data)
                        this.total = data
