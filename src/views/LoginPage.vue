<template>
    ...
    <form class="form" @submit.prevent="login">
     <div class="form-title"><span>sign in to your</span></div>
      <div class="title-2"><span>Restaurantly</span></div>
      <div class="input-container">
        <input class="input-mail" type="email" placeholder="Enter email" v-model="email">
        <span> </span>
      </div>
      ...
      <div class="input-container">
        <input class="input-pwd" type="password" placeholder="Enter password" v-model="password">
      </div>
